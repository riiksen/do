...
do is a new project using [Amber Framework](https://amberframework.org/)
...
```
shards build --production --release do
```
...
1. Fork it ( https://github.com/your-github-user/do/fork )
